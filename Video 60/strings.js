...
console.log(p.replace("po","mer")) // Replacing the word means here from porsche the po will be replaced to mer and the word will become merrsche.....
// This way we can replace the string in here with the replace word.....
console.log(a.concat(b)) // Concat means the a will be joined with the b means it will become jeetvaidehi.......
// We can add as many concats as we want in here to make it.........
console.log(p.trim()); // trim key words removes all the spaces in here....

// What does this trim mean in here.................?????
// Explain the trim.......
z= "            Hi this is white space"; // In here there are many emnem spaces, which need to be removed, so I am gonna try to remove this spaces using the trim func()
console.log(z.trim());
// And now this trim will help us in removing the emnem spaces in terminal, as u can see in output...
// Now it prints Hi this is white space